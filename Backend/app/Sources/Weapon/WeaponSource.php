...
class WeaponSource
{
    ...
    {
        $notes = str_split($noteString . 'E');

        // Because of how the data is stored, we need to find every permutation of each note string
        // (I really don't like this, but can't think of a better way right now so ¯\_(ツ)_/¯)
        ...
        return $this->db
            ...
            ->join('weapon_melody_text AS wmt', static function ($join) use ($language) {
